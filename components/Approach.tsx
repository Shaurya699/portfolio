        ...
        <Card
          title="Planning & Stratergy"
                  icon={<AceternityIcon order="Phase 1" />}
                      description="We'll collaborate to map out your goals, target audience, and key functionalities."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
          ...
          <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase 2" />}
              description="Once we agree on the plan. I cue my lofi playlist and dive into typing. From initial sketches to polished pdf's, I keep you updated every step of the way."
          >
          <CanvasRevealEffect
            animationSpeed={3}
          ...
          />
              ...
              <Card title="Development & Launch" icon={<AceternityIcon order="Phase 3" />}
                  description="This is where the magic happens! Based on the approved wordings and design, I'll make your pdf understandable, building your project from the ground up."
              >
          <CanvasRevealEffect
            animationSpeed={3}
